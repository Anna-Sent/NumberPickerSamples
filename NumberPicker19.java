...
public class NumberPicker extends LinearLayout {
		...
		if (mVirtualButtonPressedDrawable != null
			...
			if (mIncrementVirtualButtonPressed) {
				...
				mVirtualButtonPressedDrawable.setBounds(0,
						mBottomSelectionDividerBottom, mRight, mBottom);
				mVirtualButtonPressedDrawable.draw(canvas);
			}
		}
		...
		public void run() {
			...
			case MODE_PRESS: {
				...
				case BUTTON_INCREMENT: {
					...
					invalidate(0, mBottomSelectionDividerBottom, mRight,
							mBottom);
				}
					break;
	...
	class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
		...
		public AccessibilityNodeInfo createAccessibilityNodeInfo(
			...
			case View.NO_ID:
				return createAccessibilityNodeInfoForNumberPicker(mScrollX,
						mScrollY, mScrollX + (mRight - mLeft), mScrollY
								+ (mBottom - mTop));
			case VIRTUAL_VIEW_ID_DECREMENT:
				return createAccessibilityNodeInfoForVirtualButton(
						...
						mScrollX + (mRight - mLeft), mTopSelectionDividerTop
								+ mSelectionDividerHeight);
			...
			case VIRTUAL_VIEW_ID_INCREMENT:
				return createAccessibilityNodeInfoForVirtualButton(
						...
						mScrollX,
						mBottomSelectionDividerBottom - mSelectionDividerHeight,
						mScrollX + (mRight - mLeft), mScrollY
								+ (mBottom - mTop));
			}
		...
		private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(
			...
			final float applicationScale = getContext().getResources()
